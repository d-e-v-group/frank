      ...
      <section id="culture-main" data-nav-dark data-dark>
        <div class="culture-message">
          ...
          <div class="mobile-image">
            <video src="<?php echo get_template_directory_uri() . '/assets/culture-page/3/MikeJiffy1.mp4' ?>" loop autoplay playsinline muted > </video>
          </div>
        ...
        <div class="culture-images">
          <div class="culture-image-data">
              ...
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/1/Adomas-Ladder.mp4' ?>" playsinline muted></video>
              <img class="culture-pic culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/1/CJdog.png' ?>" >
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/1/Luke-Peleton.mp4' ?>" playsinline muted></video>
            
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/2/AshleyBook.mp4' ?>" playsinline muted></video>
              ...
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/3/Jay-Phone.mp4' ?>" playsinline muted></video>
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/3/MikeJiffy1.mp4' ?>" playsinline muted></video>
              ...
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/6/JiffyPeloton.mp4' ?>" playsinline muted></video>
              <img class="culture-pic culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/6/Keggen_2.png' ?>">

              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/7/Andy-Skateboard.mp4' ?>" playsinline muted></video>
              ...
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/9/CourtneyYoYo.mp4' ?>" playsinline muted></video>
              ...
              <video class="culture-vid culture-item" src="<?php echo get_template_directory_uri() . '/assets/culture-page/10/Keggen-Pong.mp4' ?>" playsinline muted></video>
