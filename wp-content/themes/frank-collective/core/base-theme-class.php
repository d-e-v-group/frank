...
abstract class base_theme_class {
    ...
    */
    ...
    {   
        ...
        /* Enqueue the Gravity Form Script */
        // add_action( 'gform_enqueue_scripts',array($this, 'load_gravity_scripts'), 10, 2 );
    ...
    */
    ...
    /**
    * Loads the gravity scripts.
    *
    */
    public function load_gravity_scripts($form, $is_ajax )
    {   
        if ( $is_ajax ) {
            wp_enqueue_script( $this->theme_name .'-gravity' , asset('compiled/js/gravity.js'), array('jquery'), $this->version, true );
        }
...
define('FORCE_HIDE_ACF_EDIT', true);